...
class NotificatorGCM extends MySQL_CRUD_API {
    ...
    public function executeCommand() {
        ...
        syslog ( LOG_INFO, "enviando APN     ");
        $res = $this->sendIOSMsg ( $_POST ["body"], $_POST ["title"], $_POST ["token"], $_POST ["action"], $db );
        syslog ( LOG_INFO, "Enviada ".$res);
